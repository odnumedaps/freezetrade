-- TOCHIPYRO Combined Script (Delta Warning + Pet Enlarger)
-- By TOCHIPYRO
...
local enlargeBtn = createButton("Pet Enlarger", 130, mainFrame)
local closeBtn = createButton("Close UI", 170, mainFrame)
